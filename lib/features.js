...
function bandLabel(value, ranges) {
...
export const GAS_SENSOR_BANDS = {
  h2s: [
    { min: 0.5, max: 8, label: "Low" },
    { min: 9, max: 16, label: "Mid-Low" },
    { min: 17, max: 25, label: "Mid" },
    { min: 26, max: 33, label: "Mid-High" },
    { min: 34, max: 42, label: "High" },
    { min: 43, max: 50, label: "Very High" },
  ],
  smoke: [
    { min: 10, max: 175, label: "Low" },
    { min: 176, max: 340, label: "Mid-Low" },
    { min: 341, max: 505, label: "Mid" },
    { min: 506, max: 670, label: "Mid-High" },
    { min: 671, max: 835, label: "High" },
    { min: 836, max: 1000, label: "Very High" },
  ],
  nh3: [
    { min: 1, max: 50, label: "Low" },
    { min: 51, max: 100, label: "Mid-Low" },
    { min: 101, max: 150, label: "Mid" },
    { min: 151, max: 200, label: "Mid-High" },
    { min: 201, max: 250, label: "High" },
    { min: 251, max: 300, label: "Very High" },
  ],
};

export function h2sBand(value) {
  return bandLabel(value, GAS_SENSOR_BANDS.h2s);
}

export function smokeBand(value) {
  return bandLabel(value, GAS_SENSOR_BANDS.smoke);
}

export function nh3Band(value) {
  return bandLabel(value, GAS_SENSOR_BANDS.nh3);
}

export function gasBands(row) {
  return {
    h2s_band: h2sBand(row?.h2s ?? row?.h2s_ppm),
    nh3_band: nh3Band(row?.nh3 ?? row?.nh3_ppm),
    smoke_band: smokeBand(row?.smoke ?? row?.smoke_ppm),
  };
}
